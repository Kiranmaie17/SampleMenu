// Page_1_Menu/script.js
const menuItems = [
    {
        name: "Broccoli & SweetCorn Soup",
        price: 120,
        category: "Starters",
        image: "https://img.freepik.com/premium-photo/broccoli-sweetcorn-soup-high-resolution-phot_1114068-44314.jpg",
        description: "Boiled sautéed broccoli and corn blended to smooth soup.",
        isVeg: true
    },
    {
        name: "Paneer Tikka",
        ...
        description: "Smoky grilled paneer cubes with Indian spices.",
        isVeg: true
    },
    {
        name: "Chicken 65",
    ...
    },
    {
        ...
        description: "Crispy spicy fried fish slices, coastal style.",
        isVeg: false
    },
    {
        name: "Rumali Roti",
        ...
        description: "Soft thin bread made on reversed tawa.",
        isVeg: true
    },
    {
        name: "Butter Naan",
        ...
        description: "Soft bread with butter and smoky flavor.",
        isVeg: true
    },
    {
        name: "Butter Chicken",
    ...
    },
    {
        ...
        price: 240,
        category: "Biryani",
        image: "https://i.ytimg.com/vi/URQDUEJHuOs/hq720.jpg",
    ...
    },
    {
        ...
        description: "Authentic Ambur style spicy chicken biryani.",
        isVeg: false
    },
    {
    ...
    },
    {
        ...
        description: "Creamy chilled coffee with ice cream.",
        isVeg: true
    }
];
...
const cartDetailTotalSpan = document.getElementById("cartDetailTotal");
...
function updateCartUI() {
    ...
    cartDetailTotalSpan.innerText = totalPrice;
    
    // Update detailed cart view
    if (cartItemsListDiv) {
        cartItemsListDiv.innerHTML = "";
        if (cart.length === 0) {
            cartItemsListDiv.innerHTML = "<p>Cart is empty</p>";
        } else {
            cart.forEach(item => {
                ...
                `;
                cartItemsListDiv.appendChild(row);
            });
        }
    }
}
...
cartToggleBtn.addEventListener("click", () => {
    cartDetailsDiv.classList.toggle("show");
});
...
clearCartBtn.addEventListener("click", () => {
    cart = [];
    updateCartUI();
    cartDetailsDiv.classList.remove("show");
});
